...
<form action="<?php echo jobController::addJob(); ?>" method="POST">
    <div class="register_form">
        ...
        <div class="row center-xs">
            <div class="col-xs-6">
            <p class="texterror"> <?php //Message::printMessage('job_name'); ?> </p>
        ...
        <div class="row center-xs">
            <div class="col-xs-6">
            <p class="texterror"> <?php //Message::printMessage('information'); ?> </p>
        ...
        <div class="row center-xs">
            <div class="col-xs-6">
            <p class="texterror"> <?php //Message::printMessage('requirements') ?> </p>
        ...
        <div class="row center-xs">
            <div class="col-xs-6">
            <p class="texterror"> <?php //Message::printMessage('sallary'); ?> </p>
